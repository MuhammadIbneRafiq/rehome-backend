-- COMPLETE PRICING FIX - COPY AND PASTE THIS INTO SUPABASE SQL EDITOR
...
-- ====================================================
-- DONE! VERIFICATION QUERIES BELOW (OPTIONAL TO RUN)
-- ====================================================

-- Show what we just updated
SELECT 'CITIES UPDATED:' as result, COUNT(*) as total_cities FROM city_base_charges;
SELECT 'FURNITURE ITEMS UPDATED:' as result, COUNT(*) as total_items FROM furniture_items;

-- Show sample of updated city pricing
SELECT city_name, normal, city_day, day_of_week FROM city_base_charges ORDER BY day_of_week LIMIT 5; 